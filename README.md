...
```
- 릴리
별도 능력치: 공격력 증가치 (%) / 공격속도 증가치 (%) 함수 추가

- 테레스
별도 능력치: 불씨 획득 확률 (%) / 강공격 발동 확률 (%) 함수 추가

- 벨라
별도 능력치: 처형 확률 (%) / 처형 기준 체력 (%) 함수 추가
```
...
- 아이르 [13슬라이드]
오기 수정
3레벨 해금: 별도 능력치 증가, 아이르 공격력의 130%로 증가
→ 별도 능력치 증가, 공격력 증가치 30% 증가

5레벨 해금: 별도 능력치 증가, 공격력 190%로 증가, 공격속도 35%로 증가
→ 별도 능력치 증가, 공격력 증가치 60% 증가, 공격속도 증가치 15% 증가
